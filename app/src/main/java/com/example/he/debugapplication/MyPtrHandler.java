...
public class MyPtrHandler extends FrameLayout implements PtrUIHandler {
    ...
    public MyPtrHandler(Context context) {
        super(context);
        initViews(null);
    }

    public MyPtrHandler(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public MyPtrHandler(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mImageView = (ImageView)header.findViewById(com.chanven.lib.cptr.R.id.ptr_classic_header_rotate_view);
...
//            mTitleTextView.setText(com.chanven.lib.cptr.R.string.cube_ptr_release_to_refresh);
    ...
    private void crossRotateLineFromBottomUnderTouch(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            ...
            mTitleTextView.setText("Pulling");
        }
    }
