...
public class MyPtrClassicDefaultHeader extends PtrClassicDefaultHeader {
    ...
    public MyPtrClassicDefaultHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public MyPtrClassicDefaultHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText("shabbying!");
        } else {
            mTitleTextView.setText("downing");
        }
    }
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText("reliese");
        }
    }
    ...
    private void crossRotateLineFromBottomUnderTouch(PtrFrameLayout frame) {
        mTitleTextView.setVisibility(VISIBLE);
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText("crossRotateLineFromBottomUnderTouch");
        } else {
            mTitleTextView.setText("crossRotateLineFromBottomUnderTouch");
        }
    }
